    ...
    return (
        <div className='p-6 grid place-items-center'>
            ...
            <div className="mt-6 mb-6">
                <Link href={`/singleplayer/language/${id}/topic/learn`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4">
                    Start Your Journey
                </Link>
                <Link href={`/singleplayer/language/${id}/topic/quiz`} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Test My Mastery
                </Link>
            </div>
        </div>
